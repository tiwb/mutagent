    ...
    return {
        ...
        "$children": [
            ...
            },
            {
                ...
                "children": btn_label,
                "onClick": Callback(btn_handler, key, view=self),
            },
        ],
    }
        ...
        "$children": [
            {
                ...
                "$id": "mcp-add-stdio",
                "children": "+ Add stdio",
                "onClick": Callback(_start_add, "stdio", view=self),
            },
            {
                "$component": "antd.Button",
                "$id": "mcp-add-http",
                "children": "+ Add HTTP",
                "onClick": Callback(_start_add, "http", view=self),
            },
        ],
    })
    ...
    if not self.editing_is_new:
        ...
        if state == "connected":
            action_right.append({
                ...
                "children": "Disconnect",
                "onClick": Callback(_btn_disconnect, key, view=self),
            })
        elif state == "failed":
            action_right.append({
                "$component": "antd.Button",
                ...
                "disabled": conn_disabled,
                "children": "Reconnect",
                "onClick": Callback(_btn_reconnect, key, view=self),
            })
        elif state == "connecting":
            action_right.append({
                "$component": "antd.Button",
            ...
            action_right.append({
                ...
                "disabled": conn_disabled,
                "children": "Connect",
                "onClick": Callback(_btn_connect, key, view=self),
            })
