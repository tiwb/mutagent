...
def _render_list(self: LLMSettingsPanel) -> list[dict[str, Any]]:
    ...
    for key, draft in self._drafts.items():
        ...
        provider_buttons.append({
            ...
            "onClick": Callback(partial(_edit_provider, key), view="@view"),
            "$children": [{
                "$component": "div",
    ...
    for provider_path in _available_provider_types():
        add_buttons.append({
            ...
            "onClick": Callback(partial(_start_add_provider, provider_path), view="@view"),
        })
    items.extend([
        {
        ...
        },
        {
            ...
            "$children": [
                ...
                },
                {
                    ...
                    "onClick": Callback(_save_all_settings, view="@view"),
                },
            ],
        },
    ])
                    ...
                    "$children": [
                        {
                            ...
                            "$children": [
                                ...
                                },
                                {
                                    ...
                                    "onClick": Callback(_discover_models, view="@view"),
                                },
                            ],
                        },
                        {
            ...
            "$children": [
                {
                    ...
                    "onClick": Callback(_delete_provider, view="@view"),
                },
                {
                    "$component": "antd.Button",
                    "$id": "save-provider",
                    ...
                    "onClick": Callback(_save_provider_edits, view="@view"),
                },
            ],
        },
    ])
